...
// 引入组件
const Table = defineAsyncComponent(() => import('/@/components/table/sourceTable.vue'));
...
const state = reactive<TableDemoState>({
	tableData: {
		...
		header: [
			...
			{ key: 'createUser', colWidth: '', title: '创建人', type: 'text', isCheck: true },
			{ key: 'updateTime', colWidth: '', title: '更新时间', type: 'text', isCheck: true },
			{ key: 'switch', colWidth: '', title: '状态', type: 'text', isCheck: true },
		],
		// 配置项（必传）
		config: {
			total: 0, // 列表总数
		...
		search: [
			...
			{ label: '数据源名称', prop: 'name', placeholder: '请输入数据源名称', required: false, type: 'input' },
