	...
	<div class="home-container layout-pd">
		...
		<el-row :gutter="15" class="home-card-three">
			<el-col :xs="24" :sm="10" :md="10" :lg="8" :xl="8">
				<div class="home-card-item">
					<div class="home-card-item-title">快速入口</div>
...
import Group788 from '/@/assets/svg/a-Group788.svg';
import Group789 from '/@/assets/svg/a-Group789.svg';
import Group790 from '/@/assets/svg/a-Group790.svg';
import Group792 from '/@/assets/svg/a-Group792.svg';
import Group794 from '/@/assets/svg/a-Group794.svg';
import Group796 from '/@/assets/svg/a-Group796.svg';
import Group797 from '/@/assets/svg/a-Group797.svg';
import Group798 from '/@/assets/svg/a-Group798.svg';
import Group801 from '/@/assets/svg/a-Group801.svg';
...
const initPieChart = () => {
	...
	var getname = ['人口数据 ', '健康数据', '电子病历数据', '医疗数据', '其他'];
...
const initBarChart = () => {
	...
	const option = {
		...
		tooltip: { trigger: 'axis' },
		legend: { data: ['元数据', '数据模型', '数据标准'], right: 0 },
