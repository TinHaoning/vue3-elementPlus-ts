	...
	<div class="table-container">
		<div class="header-menu mb10" v-if="setHeaderTitle">
			...
			<div class="buttonList">
				<div v-for="(val, key) in button" :key="key" class="ml5">
					<el-button :type="val.type" :icon="val.icon === 'Plus' ? Plus : ''">{{ val.text }}</el-button>
				</div>
			</div>
		</div>
		<el-table
		...
		>
			...
			>
				<template v-slot="scope">
					<template v-if="item.type === 'boolean'">
						<el-text class="mx-1" type="success" v-if="scope.row.syncSwitch === 'true'">启用</el-text>
						<el-text class="mx-1" type="danger" v-else>禁用</el-text>
					</template>
			...
			<!-- <el-table-column label="操作" align="center" width="200" v-if="config.isSwitch">
				<template v-slot="scope">
					<el-text class="mx-1" type="success" v-if="scope.row.switch === 'true'">启用</el-text>
					<el-text class="mx-1" type="danger" v-else>禁用</el-text>
				</template>
			</el-table-column> -->
